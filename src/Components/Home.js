          ...
          <div className="collapse navbar-collapse" id="navbarNavDropdown">
            <ul className="navbar-nav">
              <li className="nav-item active">
                <a className="nav-link" ><Link to={'/Home'}>Home</Link>
              ...
              <li className="nav-item farRight">
                <button className="btn btn-primary btnSignup"><Link to={""}>Request a Demo</Link></button>
              </li>
                   
              <li className="nav-item">
                <button className="btn btn-primary ml-2 btnRequest"><Link to={"/Login"}>Log Out</Link>
