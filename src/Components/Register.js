    ...
    <body className="call">
      ...
      <div className="container registration">
        <form>
            ...
            <div className="form-row">
                <div className="form-group col-md-12">
                    <button className="btn btn-primary registerButton"><Link to={"/Login"}>Sign Up</Link></button>
                </div>
            </div>
            <div className="form-row">
                <div className="form-group col-md-12">
                    <p className="account">Already have an account?<span><Link to='/Login'>Click here</Link></span></p>
                </div>
            </div>
        </form>
      </div>
